...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->integer('tipoProducto_id')->unsigned()->nullable(); //si..
            $table->integer('laboratorio_id')->unsigned()->nullable(); //si..
            $table->foreign('type_id')->references('id')->on('types');
            $table->foreign('brand_id')->references('id')->on('brands');
            $table->foreign('material_id')->references('id')->on('materials');
            $table->foreign('station_id')->references('id')->on('stations');
            $table->foreign('tipoProducto_id')->references('id')->on('tipoProductos');
            $table->foreign('laboratorio_id')->references('id')->on('tipoProductos');
