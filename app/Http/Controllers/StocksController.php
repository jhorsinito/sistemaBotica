...
class StocksController extends Controller {
   ...
   public function verStockActual($vari,$almacen){
    ...
    public function traerStock($product_id){
        ...
        $stock = \DB::select( \DB::raw('SELECT variants.codigo, variants.sku, stock.stockActual, stock.almacen_id,stock.porLlegar, almacenes.nombreAlmacen
FROM products
INNER JOIN variants ON products.id = variants.product_id
INNER JOIN stock ON variants.id = stock.variant_id
INNER JOIN almacenes ON stock.almacen_id = almacenes.id
