           ...
           <div class="col-md-12">
              ...
              <td >
               <div class="form-group" ng-class="{true: 'has-error'}[ paymentCreateForm.warehouse.$error.required && paymentCreateForm.$submitted || paymentCreateForm.warehouse.$dirty && paymentCreateForm.warehouse.$invalid]">
                       ...
                       <select ng-disabled="detPayment.cashe_id>0 || payment.cajamensual==true" ng-hide="show" class="form-control" name="warehouse" ng-click="" ng-model="detPayment.methodPayment_id" ng-options="item.id as item.nombre for item in methodPayments" required>
        ...
        <div class="row">
             <div ng-hide="payment.cajamensual" class="col-md-3">
                <div class="form-group" ng-class="{true: 'has-error'}[ paymentCreateForm.warehouse.$error.required && paymentCreateForm.$submitted || paymentCreateForm.warehouse.$dirty && paymentCreateForm.warehouse.$invalid]">
                       ...
                       <select  ng-disabled="detPayment.methodPayment_id>0 || check==true || payment.cajamensual==true" ng-click="TraerSales(detPayment.cashe_id)" class="form-control" name="warehouse"  ng-model="detPayment.cashe_id" ng-options="item.id as item.nombre for item in cashHeaders" required>
        ...
        <div class="col-md-6" align="center">
            ...
            <table class="table table-striped" >
                    ...
                    <tr ng-repeat="row in detPayments">
                      ...
                      <td ng-if="row.detCash_id>0">@{{row.detCash_id}}</td>
                      <td ng-if="row.cashMonthly_id>0">@{{row.cashMonthly_id}}</td>
