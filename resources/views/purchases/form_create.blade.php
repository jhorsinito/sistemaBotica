        ...
        <form name="detailPurchaseCreateForm" role="form" novalidate> 
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group" >
                ...
                <select class="form-control" name="" ng-click="sacarPrecio()" ng-model="variantsProductos.product_id" ng-options="item.id as item.sku for item in variantsProductos">
          ...
          <!-- capo de Texto  Cantidad-->
            <div class="col-md-2"> 
                ...
                <input type="number" class="form-control ng-pristine ng-valid ng-touched" name="cantidad" placeholder="0.00" ng-model="detailPurchase.cantidad" ng-blur="calculateSuppPric()" step="0.1">
            ...
            <div class="col-md-2">
               <div class="form-group" ng-class="{true: 'has-error'}[ detailPurchaseCreateForm.preCompra.$error.required && detailPurchaseCreateForm.$submitted || detailPurchaseCreateForm.preCompra.$dirty && detailPurchaseCreateForm.preCompra.$invalid]">
                ...
                <input type="text" class="form-control ng-pristine ng-valid ng-touched" name="suppPric" placeholder="0.00" ng-model="detailPurchase.preCompra" ng-blur="calculateSuppPric()" step="0.1">
            ...
            <div class="col-md-2"> 
                ...
                <input type="number" class="form-control ng-pristine ng-valid ng-touched" name="suppPric" placeholder="0.00" ng-model="detailPurchase.montoBruto" ng-blur="calculateSuppPric()" step="0.1">
            ...
            <div class="col-md-2"> 
                ...
                <input type="number" class="form-control ng-pristine ng-valid ng-touched" name="suppPric" placeholder="0.00" ng-model="detailPurchase.descuento" ng-blur="calculateSuppPric()" step="0.1">
            ...
            <div class="col-md-2"> 
                ...
                <input type="number" class="form-control ng-pristine ng-valid ng-touched" name="suppPric" placeholder="0.00" ng-model="detailPurchase.montoTotal" ng-blur="calculateSuppPric()" step="0.1">
  ...
  <!-- ==========================================================================================-->
        <div class="row">
          <div class="col-md-4"> 
                ...
                <input type="number" class="form-control ng-valid ng-dirty ng-valid-number ng-touched" name="suppPric" placeholder="0.00" ng-model="product.suppPric" ng-disabled="product.hasVariants" ng-blur="calculateSuppPric()" step="0.1">
              </div>
            </div>
            <!-- capo de Texto  Descuento-->
            <div class="col-md-4"> 
