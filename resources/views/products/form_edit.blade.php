                ...
                <form name="productCreateForm" role="form" novalidate>
                    <div class="box-body">
                        ...
                        <div class="row">
                          ...
                          <label>Tipo</label>
                                <select class="form-control ng-pristine ng-valid ng-touched" name="tienda_id" ng-model="product.tipoProducto_id" ng-options="item.id as item.nombre for item in tipoProductos" ng-click="validarTipoMedicamento()"><option value="">-- Elige Tipo --</option></select>
                                ...
                                <div class="row">
                                    <div class="col-md-6" ng-show="product.tipoProducto_id==1">
                          <div class="form-group">
                    ...
                    <div class="col-md-6" ng-show="product.tipoProducto_id==1">
                      <div class="form-group">
                        ...
                        <div class="row" ng-show="product.tipoProducto_id==1">
                    <div  class="col-md-10">
                          <input  type="text" ng-model="productoSelected" placeholder="Buscar Producto" typeahead="atributo as atributo.nombre for atributo in getService($viewValue)" typeahead-loading="loadingLocations" typeahead-no-results="noResults" class="form-control"/>
                    </div>
                    <div  class="col-md-2">
                      <a type="submit" class="btn btn-primary" ng-click="agregarEditProducto()">Validar</a>
                    </div>
                    </div>
                    <br>
                    <div class="box box-primary" ng-show="product.tipoProducto_id==1">
                      <div class="box-header with-border">
                      <h3 class="box-title">Medicamentos Relacionados</h3> 
                    </div><!-- /.box-header -->
                    <div class="box-body" >
                    ...
                    <tr ng-repeat="row in grupoProductos">
                      <td>@{{$index + 1}}</td>
                      <td>@{{row.nombre}}</td>
                      <td><a ng-click="eliminarEditProducto(row)" class="btn btn-danger btn-xs">Eliminar</a></td>
                        ...
                        <div class="box box-default" id="variants">
                            ...
                            <div class="box-body">
                                <div class="form-group" >
                                    ...
                                    <input type="checkbox" name="variantes" ng-model="product.hasVariants" ng-checked="product.hasVariants" ng-disabled="true"/>
                                                    ...
                                                    <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
                                                                                                ...
                                                                                                <div class="col-md-2">
                                                                                                    <div class="form-group" >
                                                                                                        ...
                                                                                                        <input type="number" class="form-control" name="markup" ng-attr-min="@{{minNumber}}" string-to-number placeholder="0.00"  ng-model="product.stock[$index].stockActual" ng-disabled="product.hasVariants || !product.track" step="0.1">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-2">
                                                                                                    <div class="form-group" >
                                                                                                        <label for="suppPric">Stock Mínimo</label>
                                                                                                        <input type="number" class="form-control" name="markup"  ng-attr-min="@{{minNumber}}" string-to-number placeholder="0.00"  ng-model="product.stock[$index].stockMin" ng-disabled="product.hasVariants || !product.track" step="0.1">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-2">
                                                                                                    <div class="form-group" >
                                                                                                        <label for="suppPric">Costo Mínimo</label>
                                                                                                        <input type="number" class="form-control" name="markup"  ng-attr-min="@{{minNumber}}" string-to-number placeholder="0.00"  ng-model="product.stock[$index].stockMinSoles" ng-disabled="product.hasVariants || !product.track" step="0.1">
                                                                                                    </div>
                                                                                                </div>
                                                                                                 </span>
    ...
    <div class="modal-dialog modal-md"  role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" ng-click="UpdatePres1()" data-dismiss="modal" ng-show="presentation.edit">Editar Cambios</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
