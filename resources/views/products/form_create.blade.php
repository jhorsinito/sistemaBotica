                ...
                <form name="productCreateForm" role="form" novalidate>
                  ...
                  <div class="callout callout-danger" ng-show="errors">
                    ...
                    <div class="form-group" ng-class="{true: 'has-error'}[ productCreateForm.codigo.$error.required && productCreateForm.$submitted || productCreateForm.codigo.$dirty && productCreateForm.codigo.$invalid]">
                      ...
                      ng-model="product.codigo" ng-blur="validacodigo(product.codigo)" required>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-4" ng-show="product.tipoProducto_id==1">
                        <div class="form-group">
                                <label>Laboratorio <a class="btn btn-xs btn-info btn-flat" ng-click="addLaboratorio()">+</a></label>
                                <select name="laboratorio" class="form-control" ng-model="product.laboratorio_id" ng-options="k as v for (k, v) in laboratorios">
                                <option value="">--Elige Laboratorio--</option>
                                <option value="">+Agrega Laboratorio</option>
                                </select>
                          </div>
                    ...
                    <div  class="col-md-2">
                      <a type="submit" class="btn btn-primary" ng-click="agregarProducto()">Validar</a>
                    </div>
                    </div>
                    <br>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group" >
                                                                                             ...
                                                                                             <div class="" ng-show="product.track && !product.hasVariants">
                                                                                                ...
                                                                                                <div class="form-group" >
                                                                                                 <label for=""></label>
                                                                                                   <h5>@{{ row.nombreAlmacen }}</h5>
                                                                                                   <input type="text" class="hidden" ng-model="product.stock[$index].almacen_id" ng-init="product.stock[$index].almacen_id = row.id"/>
