        ...
        <div class="col-md-12"> 
            ...
            <div class="box box-primary">
                ...
                <form name="variantCreateForm" role="form" novalidate>
                    ...
                    <div  class="col-md-10">
                          <input  type="text" ng-model="grupoFarmaceuticoSelected" placeholder="Buscar Grupo Farmaceutico" typeahead="atributo as atributo.nombre for atributo in getServiceFarmaceutoco($viewValue)" typeahead-loading="loadingLocations" typeahead-no-results="noResults" class="form-control"/>
                    </div>
                    <div  class="col-md-2">
                      <a type="submit" class="btn btn-primary" ng-click="agregarGrupoFarmaceutico()">Validar</a>
                    </div>
                    </div>
                    <br>
                    <div class="box box-primary" ng-show="product.tipoProducto_id==1">
                      <div class="box-header with-border">
                      <h3 class="box-title">Grupos Farmaceuticos</h3> 
                    </div><!-- /.box-header -->
                    <div class="box-body" >
                        <table class="table table-bordered" >
                    <tr>
                      <th style="width: 10px">#</th>
                      <th>Nombre de Grupo Farmaceutico</th>
                      <th style="width: 40px">Eliminar</th>
                    </tr>
                    
                    <tr ng-repeat="row in grupoFarmaceutico">
                      <td>@{{$index + 1}}</td>
                      <td>@{{row.nombre}}</td>
                      <td><a ng-click="eliminarGrupoFarmaceutico($index)" class="btn btn-danger btn-xs">Eliminar</a></td>
                                                    ...
                                                    <button class="btn btn-sm btn-default"><i class="fa fa-search"></i></button>
                                                                                                ...
                                                                                                <div class="col-md-3 col-md-offset-1">
                                                                                                    <div class="form-group" >
                                                                                                        ...
                                                                                                        <input type="text" class="hidden" ng-model="variant.stock[$index].almacen_id" ng-init="variant.stock[$index].almacen_id = row.id"/>
