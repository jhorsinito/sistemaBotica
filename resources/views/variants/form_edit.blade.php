        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form name="variantCreateForm" role="form" novalidate>
                    ...
                    <div  class="col-md-2">
                      <a type="submit" class="btn btn-primary" ng-click="agregarEditGrupoFarmaceutico()">Validar</a>
                    </div>
                    </div>
                    <br>
                    ...
                    <tr ng-repeat="row in grupoFarmaceutico">
                      <td>@{{$index + 1}}</td>
                      <td>@{{row.nombre}}</td>
                      <td><a ng-click="eliminarEditGrupoFarmaceutico(row)" class="btn btn-danger btn-xs">Eliminar</a></td>
