        ...
        <form name="detailOrderPurchaseCreateForm" role="form" novalidate> 
          ...
          typeahead-loading="loadingLocations" typeahead-no-results="noResults" class="form-control"
           tooltip="Ingrese caracteres para busacar producto por codigo unico"
            ...
            <div ng-if="check==true" class="col-md-2">
            ...
            <div class="col-md-2">
               ...
               <select  class="form-control" name="tcambio"  ng-model="tCambio" >
                       <option value="sol">Sol</option>
                       <option value="dolar">Dolar</option>
               </select>
           </div>
           <div ng-if="tCambio=='dolar'" class="col-md-1">
               <label for="valorCambio">Valor</label>
               <input class="form-control" ng-model="valorCambio" type="number" min="1">
           </div>
       ...
       <div class="col-md-2" >
          ...
          <div class="col-md-1">
            ...
            <div class="col-md-2"> 
                ...
                <input ng-disabled="activarCampCantidad" min='0' type="number" class="form-control ng-pristine ng-valid ng-touched" name="cantidad" id="cantidad" placeholder="0.00" ng-model="detailOrderPurchase.cantidad" ng-blur="calcPrecio()" step="1" >
