       ...
       <table class="table table-striped">
          ...
          <div class="col-md-1">
            ...
            <div class="col-md-2"> 
                ...
                <input ng-disabled="activarCampCantidad" min='0' type="number" class="form-control ng-pristine ng-valid ng-touched" name="cantidad" id="cantidad" placeholder="0.00" ng-model="detailOrderPurchase.cantidad" ng-blur="calculateSuppPric()" step="1" rquired>
