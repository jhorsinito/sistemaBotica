   ...
   <div ng-if="orderPurchase.estados==0" ng-show="estados || checkProduct" class="box box-default" id="box-addPro">
      ...
      <label></label><br/>
          ...
          <!--<div class="row">
            ...
            <div class="form-group">
            <input type="text" ng-enter="TraerPorSku(variant.sku)" placeholder="Ingresa Sku" class="form-control" ng-model="variant.sku">
            </div>
          <!--<div class="input-group">
          ...
          tooltip="Ingrese caracteres para busacar producto por sku">
            ...
            <div class="col-md-1">
               <em>¿Busca Normal?</em>
                      <div   class="form-group" >                            
                            <input  ng-disabled="check" ng-click="limpiarDatosAgregate()" type="checkbox"   ng-click="editCamEstadosJ()" ng-model="check1" />
          ...
          <div class="col-md-2"> 
            ...
            <div class="col-md-2"> 
              ...
              <div  class="col-md-2"> 
                ...
                <input string-to-number ng-disabled="true" type="number" ng-model="orderPurchase.igv" min='0' class="form-control ng-valid ng-dirty ng-valid-number ng-touched" 
             ...
             <div  class="col-md-2"> 
                ...
                <input string-to-number ng-disabled="true" type="number" ng-model="orderPurchase.montoBase" min='0' class="form-control ng-valid ng-dirty ng-valid-number ng-touched" 
                       name="descuento" placeholder="0.00"    step="0.1">
              </div>
